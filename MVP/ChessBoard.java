...
public class ChessBoard {
  ...
  public boolean validMove(String move,ChessPiece piece) {
    String coor0 = move.substring(0,1);
    String coor1 = move.substring(1,2);
    int[] temp = {Integer.parseInt(coor0),Integer.parseInt(coor1)};
