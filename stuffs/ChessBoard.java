public class ChessBoard {
	...
	/*	
		...
		m1.setPieceOnBoard(1,0,"P");
		m1.setPieceOnBoard(1,1,"P");
		m1.setPieceOnBoard(1,2,"P");
		m1.setPieceOnBoard(1,3,"P");
		m1.setPieceOnBoard(1,4,"P");
		m1.setPieceOnBoard(1,5,"P");
		m1.setPieceOnBoard(1,6,"P");
		m1.setPieceOnBoard(1,7,"P");
		
		m1.setPieceOnBoard(6,0,"P");
		m1.setPieceOnBoard(6,1,"P");
		m1.setPieceOnBoard(6,2,"P");
		m1.setPieceOnBoard(6,3,"P");
		m1.setPieceOnBoard(6,4,"P");
		m1.setPieceOnBoard(6,5,"P");
		m1.setPieceOnBoard(6,6,"P");
		m1.setPieceOnBoard(6,7,"P");
		*/
